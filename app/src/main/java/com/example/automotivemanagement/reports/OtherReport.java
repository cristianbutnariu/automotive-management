...
public class OtherReport extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        expensesList = db.getExpensesDao().loadExpenses("other", id);
        totalPaid = findViewById(R.id.priceTV);
        totalPaid.setText("Total spent: " + db.getExpensesDao().getSum("other", id) + " RON");

        otherExpenses = findViewById(R.id.otherReportLv);
        ...
        if (expensesList.size() >= 1) {
            otherExpenses.setAdapter(rlva);
        } else {
            otherExpenses.setAdapter(elva);
        }
        otherExpenses.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
        ...
        startDate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                dpd = new DatePickerDialog(OtherReport.this,
        ...
        setFilterButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (startingDate == null || endingDate == null) {
                    ...
                    expensesListFiltered = db.getExpensesDao().loadExpensesFiltered("other", id, startingDate, endingDate);
                    rlva = new ReportsListViewAdapter(expensesListFiltered, getApplicationContext());
                    otherExpenses.setAdapter(rlva);
                    totalPaid.setText("Total spent: " + db.getExpensesDao().getSumFiltered("other", id, startingDate, endingDate) + " RON");
                }
            }
        });
    }
