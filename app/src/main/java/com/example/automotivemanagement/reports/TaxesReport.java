...
public class TaxesReport extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_taxes_report);
        ...
        expensesList = db.getExpensesDao().loadExpenses("taxes", id);
        totalPaid = findViewById(R.id.priceTV);
        totalPaid.setText("Total spent: " + db.getExpensesDao().getSum("taxes", id) + " RON");

        taxesExpenses = findViewById(R.id.taxesReportLv);
        ...
        if (expensesList.size() >= 1) {
            taxesExpenses.setAdapter(rlva);
        } else {
            taxesExpenses.setAdapter(elva);
        }
        taxesExpenses.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
        ...
        startDate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                dpd = new DatePickerDialog(TaxesReport.this,
        ...
        setFilterButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (startingDate == null || endingDate == null) {
                    ...
                    expensesListFiltered = db.getExpensesDao().loadExpensesFiltered("taxes", id, startingDate, endingDate);
                    rlva = new ReportsListViewAdapter(expensesListFiltered, getApplicationContext());
                    taxesExpenses.setAdapter(rlva);
                    totalPaid.setText("Total spent: " + db.getExpensesDao().getSumFiltered("taxes", id, startingDate, endingDate) + " RON");
                }
            }
        });
    }
